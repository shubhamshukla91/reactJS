...
return(
    <div className='signup'>
        ...
        <form onSubmit={submitHandler}>
            <div>
                <label>Name</label>
                <input type="text" className='inputfields' value={fullname} onChange={(e) => setFullName(e.target.value)}></input>
            </div>
            <div>
                <label>Email</label>
            ...
            <div>
                <label>Address</label>
                <input type="text" className='inputfields'  value={address} onChange={(e) => setAddress(e.target.value)}></input>
            </div>
            <div>
                <label>submit</label>
